  ...
  return (
    <div className="bg-poly-card rounded-xl border border-poly-border p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="text-center p-3 bg-poly-dark rounded-lg">
          <div className={`text-2xl font-bold ${totalPnl >= 0 ? 'text-poly-green' : 'text-poly-red'}`}>
        ...
        <div className="text-center p-3 bg-poly-dark rounded-lg">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-2xl font-bold">{sniperWinRate}%</span>
          </div>
          <div className="text-xs text-gray-500">Sniper Rate</div>
        ...
        <div className="text-center p-3 bg-poly-dark rounded-lg">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-2xl font-bold">{noBiasWinRate}%</span>
          </div>
          <div className="text-xs text-gray-500">NO Bias Rate</div>
      ...
      {stats.avg_hold_time_hours > 0 && (
        <div className="flex items-center justify-center gap-2 mt-4 text-sm text-gray-400">
          ...
          Avg hold time: {stats.avg_hold_time_hours.toFixed(1)} hours
        </div>
      )}
    </div>
  )
